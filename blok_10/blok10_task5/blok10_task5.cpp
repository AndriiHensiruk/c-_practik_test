...
bool init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow(" Blok10_task5", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
		if (gWindow == NULL)
		{
	...
	else
	{
		...
		else
		{
			...
			while (!quit)
			{
				...
				timeText.str("");
				timeText << "Seconds start time   " << (timer.getTicks() / 1000.f);
