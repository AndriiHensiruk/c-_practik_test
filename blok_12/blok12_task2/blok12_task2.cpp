...
bool init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow("Blok12_task2", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
		if (gWindow == NULL)
		{
...
bool loadMedia()
{
	...
	{
		//Render the prompt
		if (!gPromptTextTexture.loadFromRenderedText("Number of clicks:", textColor))
		{
